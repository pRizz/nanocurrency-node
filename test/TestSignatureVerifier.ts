...
describe('SignatureVerifier', () => {
    describe('#verify()', () => {
        it('should assert a valid signature', () => {
            ...
            assert(SignatureVerifier.verify(new Uint8Array(message), signature.value.asUint8Array(), new UInt256({ uint8Array: publicKey})))
        })
        ...
        it('should not assert an invalid signature', () => {
            ...
            const modifiedSignature = signature.value.asUint8Array()
